...
<div class="full-background">
    ...
    <div class="header d-flex align-items-center">
        ...
        <h1 class="kpi-title">Tambah Data Gorika</h1>
    </div>

    <div class="container-fluid">
        <div class="card custom-card shadow-lg">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h3 class="card-title mb-0 text-white">Form Tambah Data Gorika</h3>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('gorika.store') }}" method="POST">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="total_activity" name="total_activity" value="{{ old('total_activity') }}" required>
                    </div>
                    
                    <div class="mb-3">
                        <label for="implementasi" class="form-label">Implementasi</label>
                        <input type="text" class="form-control" id="implementasi" name="implementasi" value="{{ old('implementasi') }}" required>
                    </div>
