...
<div class="full-background">
    ...
    <div class="header d-flex align-items-center">
        ...
        <h1 class="kpi-title">Tambah Data Gorika Improvement</h1>
    </div>

    <div class="container-fluid">
        <div class="card custom-card shadow-lg">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h3 class="card-title mb-0 text-white">Form Tambah Data Gorika Improvement</h3>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('gorika-improvement.store') }}" method="POST">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="field_division" name="field_division" value="{{ old('field_division') }}" required>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="gm" name="gm" value="{{ old('gm') }}" required>
                        </div>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control" id="detail_activity" name="detail_activity" rows="4" required>{{ old('detail_activity') }}</textarea>
                        </div>
                        
                        <div class="col-md-6 mb-3">
                            <label for="month" class="form-label">Month</label>
                            <input type="text" class="form-control" id="month" name="month" value="{{ old('month') }}" required>
                        </div>
                        
                        <div class="col-md-6 mb-3">
                            <label for="monthly" class="form-label">Monthly</label>
                            <input type="number" step="0.01" class="form-control" id="monthly" name="monthly" value="{{ old('monthly') }}" required>
                        </div>
                        
                        <div class="col-md-6 mb-3">
                            <label for="effect_period" class="form-label">Effect Period</label>
                            <input type="text" class="form-control" id="effect_period" name="effect_period" value="{{ old('effect_period') }}" required>
                        </div>
                        
                        <div class="col-md-6 mb-3">
                            <label for="yearly" class="form-label">Yearly</label>
                            <input type="number" step="0.01" class="form-control" id="yearly" name="yearly" value="{{ old('yearly') }}" required>
                        </div>
                        
                        <div class="col-md-6 mb-3">
                            <label for="category_pl_impact" class="form-label">Category PL Impact</label>
                            <input type="text" class="form-control" id="category_pl_impact" name="category_pl_impact" value="{{ old('category_pl_impact') }}" required>
                        </div>
                        
                        <div class="col-md-6 mb-3">
                            <label for="c" class="form-label">C</label>
                            <input type="text" class="form-control" id="c" name="c" value="{{ old('c') }}">
                        </div>
                        
                        <div class="col-md-6 mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="continue_current_model" name="continue_current_model" value="1" {{ old('continue_current_model') ? 'checked' : '' }}>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="continue_new_model" name="continue_new_model" value="1" {{ old('continue_new_model') ? 'checked' : '' }}>
